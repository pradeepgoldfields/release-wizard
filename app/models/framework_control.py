...
class FrameworkControl(db.Model):
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "dimension_keys": json.loads(self.dimension_keys_json) if self.dimension_keys_json else None,
            "evidence_keywords": json.loads(self.evidence_keywords_json) if self.evidence_keywords_json else None,
            "weight": self.weight,
